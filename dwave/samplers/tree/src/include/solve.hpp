...
using dwave::samplers::tree::MinSolution;
using dwave::samplers::tree::MinSolutionSet;

typedef dwave::samplers::tree::Task<dwave::samplers::tree::MinOperations<double, dwave::samplers::tree::Plus<double> > > SolveTask;
